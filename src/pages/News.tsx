        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl p-8 text-white text-center">
            ...
            <div className="max-w-md mx-auto flex">
              ...
              />
              <a href="https://dummylink.com" target="_blank" rel="noopener noreferrer" className="bg-white text-indigo-600 px-6 py-3 rounded-r-xl font-semibold hover:bg-gray-100 transition-colors flex items-center">
                Subscribe
              </a>
            </div>
          </div>
